...
{
    public class VariableType_GoalTemp_662026670_0 : CodeGenVariableTypeBase
    {
        public VariableType_GoalTemp_662026670_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_GoalTemp_662026670_0::Initialize");
            ...
            this.GetNode().BrowseName  = "GoalTemp";
            this.GetNode().DisplayName = "GoalTemp";
