...
*/
//Browse name: ActualTemperature_DTO
...
{
    public class VariableType_ActualTemperature_DTO_325685183_0 : CodeGenVariableTypeBase
    {
        public VariableType_ActualTemperature_DTO_325685183_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_ActualTemperature_DTO_325685183_0::Initialize");
            ...
            this.GetNode().BrowseName  = "ActualTemperature_DTO";
            this.GetNode().DisplayName = "ActualTemperature_DTO";
            ...
            string defaultValueStr  = "Numeric";
