...
{
    public class VariableType_ID_DTO_1134910354_0 : CodeGenVariableTypeBase
    {
        public VariableType_ID_DTO_1134910354_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_ID_DTO_1134910354_0::Initialize");
            ...
            this.GetNode().BrowseName  = "ID_DTO";
            this.GetNode().DisplayName = "ID_DTO";
