...
*/
//Browse name: GoalTemperature_DTO
...
{
    public class VariableType_GoalTemperature_DTO_606346491_0 : CodeGenVariableTypeBase
    {
        public VariableType_GoalTemperature_DTO_606346491_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_GoalTemperature_DTO_606346491_0::Initialize");
            ...
            this.GetNode().BrowseName  = "GoalTemperature_DTO";
            this.GetNode().DisplayName = "GoalTemperature_DTO";
